...
#Question 3: Which player scored more goals per game?. 
Do team that spend more money obtaining and paying more players translate to more wins. I will be comparing the total amount spent by each team and comparing them in a bar chart. 
...
# Question 4: Which players have the most assists?
```{r}
epl3 %>%
  filter(position != "Goalkeeper") %>%
